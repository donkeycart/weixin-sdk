...
public class JobsTest {
    ...
    private final CsvSchema USER_SCHEMA = new CsvSchema.Builder().addColumn("name").addColumn("userid").addColumn("weixinid").addColumn("mobile").addColumn("email").addArrayColumn("department").addColumn("position").build();
